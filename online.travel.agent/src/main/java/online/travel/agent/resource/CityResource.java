...
public class CityResource {
	...
	public Response addCity(City city) {
		...
		try {
			...
			LOG.warn(e);
			response = Response.noContent().entity("Exception in adding city: " + e.getMessage()).build();
		}
		return response;
	}
	...
	public Response getCity(@PathParam("id") int id) {
		...
		try {
			...
			if (result != null) {
				...
				response = Response.noContent().entity("City with given id is not found").build();
			}
		} catch (Exception e) {
			LOG.warn(e);
			response = Response.noContent().entity("Exception in fetching the city with given id: " + e.getMessage())
					.build();
		}
		return response;
	}
	...
	public Response deleteProduct(@PathParam("id") int id) {
		...
		try {
			...
			LOG.warn(e);
			response = Response.noContent().entity("Exception in deleting the city with given id: " + e.getMessage())
					.build();
		}
		return response;
	}
